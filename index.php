...
<html lang="fr-FR">
    ...
    <body>
        ...
        <section id="thematique">
            ...
            <article id="gauche"><a href="pages/route.html">Route
            <img src="css/images/casqueroute.png"></a></article>
            <article id="milieu"><a href="pages/cross.html">Cross
            <img src="css/images/casquecross.png"></a></article>
            <article id="droite"><a href="pages/piste.html">Piste
            <img src="css/images/casquepiste.png"></a></article>
        </section>
        <?php
